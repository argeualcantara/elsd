...
type AddRoutingKeyRequest struct {
	ServiceUri string `protobuf:"bytes,1,opt,name=serviceUri" json:"serviceUri,omitempty"`
	Tags       string `protobuf:"bytes,2,opt,name=tags" json:"tags,omitempty"`
	RoutinhKey string `protobuf:"bytes,3,opt,name=routinhKey" json:"routinhKey,omitempty"`
}
...
func (m *AddRoutingKeyRequest) GetRoutinhKey() string {
	if m != nil {
		return m.RoutinhKey
	}
	return ""
...
var fileDescriptor0 = []byte{
	...
	0x41, 0xa9, 0x85, 0xa5, 0xa9, 0xc5, 0x25, 0xe4, 0x98, 0x05, 0xd2, 0x53, 0x04, 0x36, 0x28, 0xc3,
	0x3b, 0xb5, 0x52, 0x82, 0x19, 0xa2, 0x07, 0x21, 0x62, 0xd4, 0xcb, 0xc8, 0xc5, 0xec, 0x9a, 0x53,
	0x2c, 0xe4, 0xc4, 0x25, 0xee, 0x9e, 0x5a, 0x82, 0xe6, 0x7a, 0xa7, 0x4a, 0x90, 0x2f, 0xf9, 0xf5,
	0x12, 0x0b, 0x32, 0xf5, 0x10, 0xce, 0x91, 0x12, 0x01, 0x0b, 0xa0, 0xa9, 0x55, 0x62, 0x10, 0x72,
	0xe2, 0xe2, 0x45, 0x71, 0xb7, 0x90, 0x24, 0x58, 0x21, 0x36, 0xbf, 0xe0, 0x32, 0x23, 0x89, 0x0d,
	0x1c, 0xd8, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xd3, 0xf2, 0x59, 0x5b, 0x79, 0x01, 0x00,
	0x00,
}
